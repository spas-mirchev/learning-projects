...
class WrapAll:
    def __init__(self) -> None:
        ...
        self.e_text = Entry(width=25, font=(
            "Helvetica", 18), textvariable=self.my_var)
        ...
        self.save_button = Button(
            width=50,
            text="Save image/images ",
            font=("Ariel.ttf", 12),
            # lambda: self.save_image(self.original_image),
    ...
    def on_key(self, var, mode, callback):
        ...
        self.font = ImageFont.truetype(
            "DejaVuSerif-Bold.ttf", self.text_size.get())
    ...
    def adjust_logo(self):
        self.logo_preview.thumbnail(
            (self.text_size.get(), self.text_size.get()))
        ...
        self.img1.paste(self.blended, (self.x.get(),
                        self.y.get()), self.blended)
        ...
        self.canvas.itemconfigure(
            self.image_container, image=self.test, tags="square")
    ...
    def process(self, ori, counter):
        ...
        self.img = Image.new(
            "RGBA", self.original_image.size, (255, 255, 255, 0))
        self.draw = ImageDraw.Draw(self.img)
        ...
        self.original_image.paste(
            self.blended, (self.xx, self.yy), self.blended)
