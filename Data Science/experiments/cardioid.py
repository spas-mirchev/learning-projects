...
class Cardioid:
    ...
    def draw(self):
        ...
        self.radius = 260 + 50 * abs(math.sin(time * 0.004) - 0.5)
        ...
        for i in range(self.num_lines):
            ...
            x2 = int(self.radius * math.cos(factor * theta)) + \
                self.translate[0]
            y2 = int(self.radius * math.sin(factor * theta)) + \
                self.translate[1]

            pg.draw.aaline(self.app.screen, self.get_color(),
                           (x1, y1), (x2, y2))
